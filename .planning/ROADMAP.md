...
**Plans**: 6 plans
- [x] 03-01-PLAN.md — Wave 1: substrate refactor (SearchStack, persistent killers/history, info.max_depth, g_tt migration) + 11 Wave 0 test stubs + baseline-phase3 gauntlet checkpoint (Phase 1 perf-bug fixes per D-01/D-03)
