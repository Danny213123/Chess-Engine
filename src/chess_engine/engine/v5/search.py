...
from chess_engine.engine.v5.board import BoardState, WP, BP
...
from chess_engine.engine.v5.eval import evaluate, INFINITY, MATE_SCORE, DRAW_SCORE
from chess_engine.engine.v5.tt import TT, TT_EXACT, TT_ALPHA, TT_BETA
...
def get_lmr_reduction(depth: int, move_number: int, pv_node: bool) -> int:
    ...
    Uses logarithmic formula a logarithmic.
    """
