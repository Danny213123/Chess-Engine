"""
V5d Chess Algorithm Adapter
Integrates the V5d bitboard engine with the existing GameState interface.
Implements improvements from IMPROVEMENT_PLAN.md with 5 second search time.
"""

import time
from typing import Optional

from chess_engine.engine.v5d.board import BoardState
from chess_engine.engine.v5d.search import search, DEFAULT_TIME_LIMIT
from chess_engine.engine.v5d.move_gen import move_to_string, generate_legal_moves
...
def find_best_move(game_state, valid_moves, engine, search_info=None):
    ...
    """
    print(f"[V5d] Improved Engine - 5s Search with Check Extensions")
