...
// =============================================================================
//
// NOTE (checker issue #3): make_move / unmake_move DO NOT touch any history
// stack. Plan 03 wraps make/unmake at the search layer with the Engine-side
// history push/pop calls. Board stays perft-clean.
