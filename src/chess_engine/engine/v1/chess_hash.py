...
def get_zobrist_file_path():
    return os.path.join(os.path.dirname(__file__), "Zobrist_keys.txt")
...
def save_zobrist():
    ...
    with open(get_zobrist_file_path(), "w") as file:
...
def load_zobrist():
    ...
    filepath = get_zobrist_file_path()
    ...
    try:
        ...
        with open(filepath, "r") as file:
            ...
            buffer = []
            final_line = file.readline().strip()
            if final_line:
