...
// Opening development
constexpr int MINOR_DEVELOPMENT_BONUS = 18;
constexpr int CENTER_PAWN_BONUS = 12;
constexpr int CENTER_CONTROL_BONUS = 3;
constexpr int CASTLED_KING_BONUS = 35;
constexpr int CASTLING_READY_BONUS = 15;
constexpr int EARLY_ROOK_MOVE_PENALTY = 24;
constexpr int EARLY_QUEEN_MOVE_PENALTY = 30;
