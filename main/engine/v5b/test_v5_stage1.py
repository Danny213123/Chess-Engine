...
from main.engine.v5.magic import get_rook_attacks, get_bishop_attacks, get_queen_attacks
from main.engine.v5.zobrist import compute_hash
...
class TestZobristHashing:
    ...
    def test_zobrist_keys_exist(self):
        ...
        from main.engine.v5.zobrist import PIECE_KEYS, SIDE_KEY, CASTLE_KEYS, EP_KEYS
