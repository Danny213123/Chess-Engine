"""
V5b Evaluation - Enhanced Static Position Evaluation with Numba JIT
Includes: Rook bonuses, Knight outposts, Bad bishop penalties
"""

import numpy as np
from numba import njit, uint64, int32, boolean

from main.engine.v5b.bitboard import (
    popcount, bitscan_forward, iter_bits,
    KNIGHT_ATTACKS, KING_ATTACKS,
    RANK_2, RANK_3, RANK_6, RANK_7
)
from main.engine.v5b.magic import (
...
from main.engine.v5b.board import BoardState, WP, WN, WB, WR, WQ, WK, BP, BN, BB, BR, BQ, BK
